...
const TaskForm = ({onClose}) => {
    ...
    const handleDropdownChange = (e) => {
      ...
      if (selectedOption === "today") {
        ...
        const daysUntilWeekend = dayOfWeek === 5 ? 1 : dayOfWeek === 6 ? 0 : 5 - dayOfWeek;
    ...
    return (
      <div className="vertical-form-container">
        <div>
            {isEdit ? <h2 className="form-title">Edit Task</h2> :<h2 className="form-title">Create Task</h2>}
        </div>
        <form >  
          ...
          <div className="form-row">
            ...
            <select className="form-dropdown" value={dueDate} onChange={handleDropdownChange}>
          ...
          <div className="add-submit">
            {isEdit ? <button className="form-button" onClick={handleEdit}>Edit</button> : <button className="form-button" onClick={handleSubmit}>Submit</button>}
            <Link to={`/home`} style={{ textDecoration: 'none' }}><button className="close-button" onClick={onClose}>Close</button></Link>
          </div>
        </form>
      </div>
    );
